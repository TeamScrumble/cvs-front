...
import { deleteReviewLike } from "@/api/review";
import { queryKeys } from "@/constants/queryKey";

const useDeleteReviewLike = (productId: number, filter: ReviewFilter) => {
  const queryKey = [
    productId,
    queryKeys.REVIEW,
...
export default useDeleteReviewLike;
